...
def all_products(request):
    ...
    categoryChoice = ['body_trim', 'body_build', 'body_maintain']
    sort = None
    direction= None

    products = products.filter(category__name__in=categoryChoice)
    categories = Category.objects.filter(name__in=categoryChoice)
